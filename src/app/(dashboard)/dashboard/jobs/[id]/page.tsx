  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4 text-gray-700">
        ...
        <div className="flex items-center gap-2">
          <DollarSign className="w-4 h-4" /> {job.salary.currency} {job.salary.min.toLocaleString()} - {job.salary.currency} {job.salary.max.toLocaleString()} {job.salary.type === "monthly" ? "/mo" : "/yr"}
        </div>
        <div className="flex items-center gap-2">
